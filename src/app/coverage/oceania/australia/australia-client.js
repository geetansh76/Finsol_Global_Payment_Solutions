...
/* ====== SEO constants (replace placeholders) ====== */
const PAGE_URL = "https://www.finsol.group/coverage/oceania/australia";
const HOME_URL = "https://www.finsol.group";
const OG_IMAGE_URL =
  "https://www.finsol.group/icons/industries-icons/digital & subscription/elearning.png"; // 1200x630 recommended
...
export default function AustraliaPage() {
  ...
  const [activeSolution, setActiveSolution] = useState("PayIns"); // interactive tabs
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Helping businesses across Australia streamline payments, reduce operational friction, and unlock greater financial efficiency with scalable solutions."
          showHero={true}
      ...
      {/* ==== Solutions (interactive, same copy pattern as Japan; country swapped) ==== */}
      <motion.section
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Australia, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in
                    Australia, we support a wide variety of local payment methods — 
                  ...
                  <p className={styles.paragraph}>
                    ...
                    you are a startup expanding into Australia or an established
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Australia, enabling
                    businesses to disburse payments quickly, securely and in
                    full compliance with local regulations. As a trusted payout
                    service provider in Australia, we support a wide range of payout
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Australia or an
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Australia, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Australia, Finsol enables you to
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          <motion.div className={`${styles.category} ${styles.withVideoBg}`} variants={rise} custom={1}>
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image
                  src="/icons/countries-icon/oceania/australia/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/oceania/australia/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/oceania/australia/after-pay.png"
                  alt="Afterpay (BNPL)"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/oceania/australia/osko.png"
                alt="Osko / Faster Payments"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/oceania/australia/pay-id.png"
                alt="PayID"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image
                src="/icons/countries-icon/oceania/australia/after-pay.png"
                alt="Apple/Google Pay (placeholder icon)"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/oceania/australia/pay-pal.png"
                alt="PayPal"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/oceania/australia/zip.png"
                alt="Zip (BNPL)"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={9}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={10}>
              ...
              />
              <Image
                src="/icons/countries-icon/oceania/australia/b-pay.png"
                alt="BPAY"
                width={120}
                height={60}
              />
