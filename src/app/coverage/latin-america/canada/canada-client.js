...
export default function CanadaPage() {
  ...
  const [activeSolution, setActiveSolution] = useState("PayIns"); // ✅ interactive tabs like japan/page.js
  ...
  return (
    <>
      {/* JSON-LD (kept here exactly as you had it) */}
      <Script
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Our advanced payment systems help businesses in Canada streamline transactions, cut costs, and improve financial control with ease."
          showHero={true}
      ...
      {/* ===================== Solutions (updated to Japan-style tabs) ===================== */}
      <motion.section
              ...
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Canada, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in
                    Canada, we support a wide variety of local payment methods —
                  ...
                  <p className={styles.paragraph}>
                    ...
                    you are a startup expanding into Canada or an established
              ...
              {activeSolution === "PayOuts" && (
                <>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Canada or an
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Canada, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Canada, Finsol enables you to
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/latin-america/canada/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/latin-america/canada/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/latin-america/canada/interac.png"
                  alt="Interac"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              ...
              />
              <Image
                src="/icons/countries-icon/latin-america/canada/paypal.png"
                alt="PayPal"
                width={120}
                height={60}
              />
