...
/* =========================
   SEO (replace placeholders)
   ========================= */
const PAGE_URL = "https://www.finsol.group/coverage/north-america/usa"; // fixed continent path only
...
export default function USAPage() {
  ...
  const [activeSolution, setActiveSolution] = useState("PayIns"); // default
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Our advanced payment solutions simplify financial processes, giving American businesses the speed, control, and efficiency they need to grow."
          showHero={true}
      ...
      {/* ==== Solutions (interactive, like Japan) ==== */}
      <motion.section
      ...
      >
        <motion.div className={styles.container} variants={containerStagger}>
          {/* Left column - clickable nav like Japan */}
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            <motion.div
              key={activeSolution} // force remount for smooth swap
              ...
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in USA, helping businesses accept payments online through secure, fast, and fully compliant systems. As a payin service provider in USA, we support a wide variety of local payment methods — including credit cards, bank transfers, UPI, and mobile wallets. These localized options help businesses receive payments online from both local consumers and international customers, streamlining the checkout experience and boosting conversions.

                  </p>
                  <p className={styles.paragraph}>
                  Our online payment services are tailored to meet the needs of businesses operating in digital economy. We offer real-time processing, multi-currency support, customizable checkout solutions, and seamless integration with e-commerce platforms, SaaS applications, and mobile apps. Whether you re a startup expanding into USA or an established brand optimizing local payments, Finsol delivers reliable, scalable, and fully localized online payment solutions in USA.
                  </p>
                </>
              )}
...
Finsol provides advanced payout solutions in United States, enabling businesses to disburse payments quickly, securely and in full compliance with local regulations. As a trusted payout service provider in United States, we support a wide range of payout methods - including bank transfers, prepaid cards, mobile wallets and international remittances. These flexible options help businesses streamline vendor settlements, employee salaries, partner commissions and customer refunds with ease.
                  </p>
                  <p className={styles.paragraph}>
                   Our payout services are designed for the digital economy, offering real-time processing, multi-currency support, bulk payouts and customizable workflows. With seamless integration into e-commerce platforms, fintech applications and enterprise systems, businesses can automate disbursements and ensure faster, error-free transactions. Whether you are a startup scaling operations in United States or an enterprise managing global partners, Finsol delivers reliable, scalable and fully localized payout solutions.
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                  Finsol offers fully customizable white label payment solutions in United States, allowing businesses to launch their own branded payment platform with complete control over the user experience, features, and pricing. As a leading white label provider, we deliver the technology, infrastructure, and compliance support you need to enter the payments market with speed and confidence.

                  </p>
                  <p className={styles.paragraph}>
                    

Our white-label payment gateway supports local payment methods, multi-currency processing, and real-time transaction management. Whether you are a fintech startup or an enterprise expanding into United States, Finsol enables you to offer secure and scalable online payment services under your brand. With full API access, localization options, and regulatory compliance built in, we make it easy to go to market quickly with a robust payment solution tailored for United States.
                  </p>
                </>
              )}
            </motion.div>
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          >
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image
                  src="/icons/countries-icon/latin-america/usa/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/latin-america/usa/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/latin-america/usa/american-express.png"
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/latin-america/usa/ach-transfer.png"
                alt="ACH Transfers"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/latin-america/usa/zelle.png"
                alt="Zelle"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/latin-america/usa/paypal.png"
                alt="PayPal"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/latin-america/usa/apple.png"
                alt="Apple Pay"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/latin-america/usa/venmo.png"
                alt="Venmo"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/latin-america/usa/g-pay.png"
                alt="Google Pay"
                width={120}
                height={60}
              />
