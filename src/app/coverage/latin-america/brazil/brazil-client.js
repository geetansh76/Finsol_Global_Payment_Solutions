// app/coverage/latin-america/brazil/brazil-client.js
"use client";
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Helping businesses across Brazil streamline payments, reduce operational friction, and unlock greater financial efficiency with scalable solutions."
          showHero={true}
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Brazil, helping businesses accept
                    payments online through secure, fast, and fully compliant systems. As a payin service
                    provider in Brazil, we support a wide variety of local payment methods — including
                    credit/debit cards, Pix instant transfers, Boleto Bancário, and bank transfers. These
                    localized options help businesses receive payments online from both local consumers and
                    international customers, streamlining the checkout experience and boosting conversions.
                  </p>

                  <p className={styles.paragraph}>
                    Our online payment services are tailored to meet the needs of Brazil dynamic digital
                    economy. We offer real-time processing, multi-currency support, customizable checkout
                    solutions, and seamless integration with e-commerce platforms, SaaS applications, and
                    mobile apps. Whether you are a startup expanding into Brazil or an established brand
                    optimizing local payments, Finsol delivers reliable, scalable, and fully localized
                    online payment solutions in Brazil.
                  </p>
                </>
              )}
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Brazil, enabling businesses to disburse
                    payments quickly, securely and in full compliance with local regulations. As a trusted
                    payout service provider in Brazil, we support a wide range of payout methods — including
                    bank transfers, prepaid cards, mobile wallets and international remittances. These
                    flexible options help businesses streamline vendor settlements, employee salaries,
                  ...
                  <p className={styles.paragraph}>
                    ...
                    multi-currency support, bulk payouts and customizable workflows. With seamless integration
                    into e-commerce platforms, fintech applications and enterprise systems, businesses can
                    automate disbursements and ensure faster, error-free transactions. Whether you are a startup
                    scaling operations in Brazil or an enterprise managing global partners, Finsol delivers
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol offers fully customizable white label payment solutions in Brazil, allowing
                    businesses to launch their own branded payment platform with complete control over the
                    user experience, features, and pricing. As a leading white label provider, we deliver the
                    technology, infrastructure, and compliance support you need to enter the payments market
                    with speed and confidence.
                  </p>
                  <p className={styles.paragraph}>
                    Our white-label payment gateway supports local payment methods, multi-currency processing,
                    and real-time transaction management. Whether you are a fintech startup or an enterprise
                    expanding into Brazil, Finsol enables you to offer secure and scalable online payment
                    services under your brand. With full API access, localization options, and regulatory
                    compliance built in, we make it easy to go to market quickly with a robust payment solution
                    tailored for Brazil.
                  </p>
                </>
              )}
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          >
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image
                  src="/icons/countries-icon/latin-america/brazil/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/latin-america/brazil/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/latin-america/brazil/celo.png"
                  alt="Elo"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/latin-america/brazil/pix.png"
                alt="Pix"
                width={120}
                height={60}
              />
          ...
          {/* UPI */}
          <motion.div className={styles.category} variants={rise} custom={3}>
            <h3 className={styles.categoryTitle}>UPI</h3>
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/latin-america/brazil/pix.png"
                alt="Pix"
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              ...
              />
              <Image
                src="/icons/countries-icon/latin-america/brazil/boleto.png"
                alt="Boleto Bancário"
                width={120}
                height={60}
              />
