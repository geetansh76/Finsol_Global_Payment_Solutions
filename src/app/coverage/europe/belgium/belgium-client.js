// app/coverage/europe/belgium/belgium-client.js (client component)
"use client";
...
export default function BelgiumClient() {
  ...
  const [activeSolution, setActiveSolution] = useState("PayIns"); // tabs
  ...
  useEffect(() => {
    ...
    // Fallback single-title animation
    const titleFallback =
      scope.querySelector("h1") ||
      scope.querySelector(`.${styles.industriesTitle}`);
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Providing fast, secure, and scalable payment systems for Belgian businesses — enabling growth through smarter financial transactions."
          showHero={true}
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Belgium, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in Belgium, we
                  ...
                  <p className={styles.paragraph}>
                    ...
                    expanding into Belgium or an established brand optimizing local
                    payments, Finsol delivers reliable, scalable, and fully localized
                    online payment solutions in Belgium.
                  </p>
                </>
              )}
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Belgium, enabling
                    businesses to disburse payments quickly, securely and in
                    full compliance with local regulations. As a trusted payout
                    service provider in Belgium, we support a wide range of payout
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Belgium or an
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Belgium, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Belgium, Finsol enables you to
      ...
      {/* Payment Methods with video background */}
      <motion.section
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          <motion.div className={`${styles.category} ${styles.withVideoBg}`} variants={rise} custom={1}>
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image src="/icons/countries-icon/europe/belgium/visa.png" alt="Visa" width={120} height={60} />
                <Image src="/icons/countries-icon/europe/belgium/master-card.png" alt="Mastercard" width={120} height={60} />
                <Image src="/icons/countries-icon/europe/belgium/ban-contact.png" alt="Bancontact" width={120} height={60} />
              </motion.div>
            </div>
          </motion.div>

          {/* QR Payments (Payconiq by Bancontact) */}
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/europe/belgium/ban-contact.png"
          ...
          {/* Bank Transfers (placeholder icon retained) */}
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              ...
              />
              <Image
                src="/icons/countries-icon/europe/belgium/pay-pal.png"
                alt="PayPal"
                width={120}
                height={60}
              />
