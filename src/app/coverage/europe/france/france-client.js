...
export default function FranceClient() {
  ...
  useEffect(() => {
    ...
    // Animate multiline hero title if present
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Finsol provides secure and scalable pay-in, payout, and gateway solutions tailored for France’s dynamic business environment."
          showHero={true}
      ...
      {/* Solutions (tabbed; paragraphs standardized, country name = France) */}
      <motion.section
              ...
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in France, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in
                    France, we support a wide variety of local payment methods —
                  ...
                  <p className={styles.paragraph}>
                    ...
                    are a startup expanding into France or an established brand
              ...
              {activeSolution === "PayOuts" && (
                <>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in France or an
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in France, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into France, Finsol enables you to
      ...
      {/* Payment Methods with video background (paths unchanged) */}
      <motion.section
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/europe/france/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/europe/france/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/europe/france/cb.png"
                  alt="Cartes Bancaires (CB)"
                  width={120}
                  height={60}
                />
              </motion.div>
          ...
          {/* QR / Proximity (local wallets) */}
          <motion.div className={styles.category} variants={rise} custom={3}>
            <h3 className={styles.categoryTitle}>QR / Proximity</h3>
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/europe/france/lydia.png"
                alt="Lydia"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/europe/france/apple-pay.png"
                alt="Apple Pay"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/europe/france/sepa.png"
                alt="SEPA Transfer"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image
                src="/icons/countries-icon/europe/france/pay-pal.png"
                alt="PayPal"
                width={120}
                height={60}
              />
          ...
          {/* Internet Banking (SEPA Direct Debit) */}
          <motion.div className={styles.category} variants={rise} custom={9}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={10}>
              <Image
                src="/icons/countries-icon/europe/france/sepa-dd.png"
