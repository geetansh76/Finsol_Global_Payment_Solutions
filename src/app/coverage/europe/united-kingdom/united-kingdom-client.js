// app/coverage/europe/united-kingdom/united-kingdom-client.js
"use client";
...
// Define the "rise" animation variant
const rise = {
...
export default function UnitedKingdomClient() {
  ...
  // Handle the active solution change
  ...
  return (
    <>
      ...
      {/* ✅ Solutions Section (FIXED: uses styles.container, with left/right siblings) */}
      <motion.section
