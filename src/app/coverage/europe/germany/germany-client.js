    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Finsol provides secure and scalable pay-in, payout, and gateway solutions tailored for Germany’s dynamic and fast-evolving business environment."
          showHero
      ...
      {/* Solutions (tabs; standardized paragraphs with country = Germany) */}
      <motion.section
              ...
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Germany, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in
                    Germany, we support a wide variety of local payment methods
                  ...
                  <p className={styles.paragraph}>
                    ...
                    are a startup expanding into Germany or an established brand
              ...
              {activeSolution === "PayOuts" && (
                <>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Germany or
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Germany, allowing businesses to launch their
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Germany, Finsol enables you to
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/europe/germany/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/europe/germany/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              ...
              />
              <Image
                src="/icons/countries-icon/europe/germany/sofort.png"
                alt="Sofort"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/europe/germany/sepa.png"
                alt="SEPA Credit Transfer"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/europe/germany/giropay.png"
                alt="giropay"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image
                src="/icons/countries-icon/europe/germany/pay-pal.png"
                alt="PayPal"
                width={120}
                height={60}
              />
