// app/coverage/europe/sweden/sweden-client.js
"use client";
...
export default function SwedenClient() {
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          title={
            <h1 className={styles.heroTitle}>
              <span className={`${styles.line} ${styles.blueLine}`}>
                Enabling Smarter Financial
              </span>

              <span className={`${styles.line} ${styles.whiteLine}`}>
                Operations Across Sweden
              </span>
          ...
          description="Supporting Swedish businesses with fast, reliable payment solutions that enhance efficiency and simplify financial operations at every stage."
              ...
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Sweden, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in
                    Sweden, we support a wide variety of local payment methods —
                  ...
                  <p className={styles.paragraph}>
                    ...
                    you are a startup expanding into Sweden or an established
              ...
              {activeSolution === "PayOuts" && (
                <>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Sweden or an
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Sweden, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Sweden, Finsol enables you to
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/europe/sweden/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/europe/sweden/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/europe/sweden/swish.png"
                  alt="Swish"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={2}>
            <h3 className={styles.categoryTitle}>Mobile Payments</h3>
            <motion.div className={styles.iconsRow} variants={rise} custom={3}>
              ...
              />
              <Image
                src="/icons/countries-icon/europe/sweden/klarna.png"
                alt="Klarna"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={4}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={5}>
              <Image
                src="/icons/countries-icon/europe/sweden/bankgirot.png"
                alt="Bankgirot"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/europe/sweden/plusgirot.png"
                alt="Plusgirot"
                width={120}
                height={60}
              />
