...
export default function IndonesiaClient() {
  ...
  // --- Solutions state (same pattern as japan/thailand you asked to keep) ---
  ...
  return (
    <>
        ...
        <Header
          title={
            <h1 className={styles.heroTitle}>
              <span className={`${styles.line} ${styles.blueLine}`}>Connecting Indonesia’s</span>
              <span className={`${styles.line} ${styles.whiteLine}`}>Businesses to a Smarter</span>
              <span className={`${styles.line} ${styles.blueLine}`}>Way to Pay</span>
            </h1>
          }
          description="Helping businesses in Indonesia modernize how they move money—locally and globally. Finsol provides secure, scalable payment solutions built for progress."
          showHero={true}
      ...
      {/* Solutions (kept same structure you requested) */}
      <motion.section
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Indonesia, helping businesses accept payments online
                    through secure, fast, and fully compliant systems. As a payin service provider in Indonesia, we support
                    a wide variety of local payment methods — including credit cards, bank transfers, UPI, and mobile
                    wallets. These localized options help businesses receive payments online from both local consumers and
                  ...
                  <p className={styles.paragraph}>
                    ...
                    expanding into Indonesia or an established brand optimizing local payments, Finsol delivers reliable,
                    scalable, and fully localized online payment solutions in Indonesia.
                  </p>
                </>
              )}
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Indonesia, enabling businesses to disburse payments
                    quickly, securely and in full compliance with local regulations. As a trusted payout service provider
                    in Indonesia, we support a wide range of payout methods - including bank transfers, prepaid cards,
                  ...
                  <p className={styles.paragraph}>
                    ...
                    error-free transactions. Whether you are a startup scaling operations in Indonesia or an enterprise
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol offers fully customizable white label payment solutions in Indonesia, allowing businesses to
                  ...
                  <p className={styles.paragraph}>
                    ...
                    transaction management. Whether you are a fintech startup or an enterprise expanding into Indonesia,
                    ...
                    quickly with a robust payment solution tailored for Indonesia.
                  </p>
                </>
              )}
            </motion.div>
      ...
      >
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          <motion.div className={`${styles.category} ${styles.withVideoBg}`} variants={rise} custom={1}>
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image src="/icons/countries-icon/asia/indonesia/visa.png" alt="Visa" width={120} height={60} />
                <Image src="/icons/countries-icon/asia/indonesia/master-card.png" alt="Mastercard" width={120} height={60} />
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            <h3 className={styles.categoryTitle}>QR Payments (QRIS)</h3>
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image src="/icons/countries-icon/asia/indonesia/ovo.png" alt="QRIS via OVO" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/indonesia/go-pay.png" alt="QRIS via GoPay" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/indonesia/dana.png" alt="QRIS via DANA" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image src="/icons/countries-icon/asia/indonesia/bi-fast.png" alt="BI-FAST" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image src="/icons/countries-icon/asia/indonesia/ovo.png" alt="OVO" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/indonesia/dana.png" alt="DANA" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/indonesia/go-pay.png" alt="GoPay" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/indonesia/link-aja.png" alt="LinkAja" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={9}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={10}>
              <Image src="/icons/countries-icon/asia/indonesia/bi-fast.png" alt="BI-FAST Online" width={120} height={60} />
            </motion.div>
          </motion.div>
        </motion.div>
      </motion.section>
