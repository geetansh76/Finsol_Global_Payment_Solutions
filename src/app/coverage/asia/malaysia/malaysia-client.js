...
/* =========================
   ...
   ========================= */
const PAGE_URL = "https://www.finsol.group/coverage/asia/malaysia";
...
export default function MalaysiaClient() {
  ...
  useEffect(() => {
    ...
    // Animate custom multiline title if present
  ...
  // Solutions state (same structure as japan/thailand you asked to keep)
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="We provide end-to-end pay-in, payout, and gateway solutions built for the Malaysian economy. Secure, seamless, and scalable — designed to grow with your business."
          showHero={true}
      ...
      {/* Solutions (kept same structure you prefer) */}
      <motion.section
              ...
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Malaysia,
                    helping businesses accept payments online through secure,
                    fast, and fully compliant systems. As a payin service
                    provider in Malaysia, we support a wide variety of local
                  ...
                  <p className={styles.paragraph}>
                    ...
                    are a startup expanding into Malaysia or an established
              ...
              {activeSolution === "PayOuts" && (
                <>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Malaysia or
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Malaysia, allowing businesses to launch their
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Malaysia, Finsol enables you to
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/asia/malaysia/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/asia/malaysia/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/asia/malaysia/touch-go.png"
                alt="Touch 'n Go"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/asia/malaysia/boost.png"
                alt="Boost"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/asia/malaysia/ibg.png"
                alt="IBG"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              ...
              />
              <Image
                src="/icons/countries-icon/asia/malaysia/grab-pay.png"
                alt="GrabPay"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={9}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={10}>
              <Image
                src="/icons/countries-icon/asia/malaysia/fpx.png"
                alt="FPX"
                width={120}
                height={60}
              />
