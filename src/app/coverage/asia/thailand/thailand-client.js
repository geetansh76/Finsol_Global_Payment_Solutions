// app/coverage/asia/thailand/thailandclient.js
"use client";
...
/* =====================
   SEO constants (used for JSON-LD here)
   ===================== */
...
export default function ThailandClient() {
  ...
  const onTabKeyDown = (e) => {
    const order = ["PayIns", "PayOuts", "WhiteLabeling"];
    const idx = order.indexOf(activeSolution);
    if (e.key === "ArrowRight") setActiveSolution(order[(idx + 1) % order.length]);
    if (e.key === "ArrowLeft") setActiveSolution(order[(idx - 1 + order.length) % order.length]);
  };
        ...
        <Header
          title={
            <h1 className={styles.heroTitle}>
              <span className={`${styles.line} ${styles.blueLine}`}>Accelerating Business in</span>
              <span className={`${styles.line} ${styles.whiteLine}`}>Thailand with Smarter</span>
              <span className={`${styles.line} ${styles.blueLine}`}>Payment Solutions</span>
            </h1>
          }
          description="Empowering businesses with reliable, compliant, and seamless payment solutions to grow and operate confidently in Thailand’s dynamic market."
          showHero={true}
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Thailand, helping businesses accept payments online through secure, fast, and fully compliant systems. As a payin service provider in Thailand, we support a wide variety of local payment methods — including credit cards, bank transfers, UPI, and mobile wallets. These localized options help businesses receive payments online from both local consumers and international customers, streamlining the checkout experience and boosting conversions.
                  </p>
                  <p className={styles.paragraph}>
                    Our online payment services are tailored to meet the needs of businesses operating in digital economy. We offer real-time processing, multi-currency support, customizable checkout solutions, and seamless integration with e-commerce platforms, SaaS applications, and mobile apps. Whether you are a startup expanding into Thailand or an established brand optimizing local payments, Finsol delivers reliable, scalable, and fully localized online payment solutions in Thailand.
                  </p>
                </>
              )}
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Thailand, enabling businesses to disburse payments
                    quickly, securely and in full compliance with local regulations. As a trusted payout service provider
                    in Thailand, we support a wide range of payout methods - including bank transfers, prepaid cards,
                  ...
                  <p className={styles.paragraph}>
                    ...
                    error-free transactions. Whether you are a startup scaling operations in Thailand or an enterprise
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol offers fully customizable white label payment solutions in Thailand, allowing businesses to
                  ...
                  <p className={styles.paragraph}>
                    ...
                    transaction management. Whether you are a fintech startup or an enterprise expanding into Thailand,
                    ...
                    quickly with a robust payment solution tailored for Thailand.
                  </p>
                </>
              )}
            </motion.div>
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          <motion.div className={`${styles.category} ${styles.withVideoBg}`} variants={rise} custom={1}>
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image src="/icons/countries-icon/asia/thailand/visa.png" alt="Visa" width={120} height={60} />
                <Image src="/icons/countries-icon/asia/thailand/master-card.png" alt="Mastercard" width={120} height={60} />
                <Image src="/icons/countries-icon/asia/thailand/union-pay.png" alt="UnionPay" width={120} height={60} />
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image src="/icons/countries-icon/asia/thailand/prompt-pay.png" alt="PromptPay" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image src="/icons/countries-icon/asia/thailand/prompt-pay.png" alt="PromptPay Bank Transfer" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image src="/icons/countries-icon/asia/thailand/true-money.png" alt="TrueMoney Wallet" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/thailand/line-pay.png" alt="LINE Pay" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={9}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={10}>
              <Image src="/icons/countries-icon/asia/thailand/scb.png" alt="SCB (Siam Commercial Bank)" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/thailand/kbank.png" alt="KBank (Kasikornbank)" width={120} height={60} />
            </motion.div>
          </motion.div>
        </motion.div>
      </motion.section>
