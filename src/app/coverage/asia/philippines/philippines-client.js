...
/* =========================
   ...
   ========================= */
const PAGE_URL = "https://www.finsol.group/coverage/asia/philippines";
const HOME_URL = "https://www.finsol.group";
const OG_IMAGE_URL = "https://www.finsol.group/icons/industries-icons/digital & subscription/elearning.png";


/* Variants (consistent with other country pages) */
...
export default function PhilippinesClient() {
  /* 🔸 Animate Header title + description without editing Header */
  ...
  useEffect(() => {
    ...
    // Animate multiline custom title
    ...
    // Fallback for a single h1/title
    const titleFallback =
  ...
  // Solutions state (keep structure consistent with your preference)
  ...
  return (
    <>
      ...
      {/* Scope wrapper only for querying header DOM; content unchanged */}
      <div ref={headerScopeRef}>
        <Header
          title={
            <h1 className={styles.heroTitle}>
              <span className={`${styles.line} ${styles.blueLine}`}>Powering Payment</span>
              <span className={`${styles.line} ${styles.whiteLine}`}>Solutions for the Philippines’</span>
              <span className={`${styles.line} ${styles.blueLine}`}>Growing Economy</span>
            </h1>
          }
          description="Delivering pay-in, payout, and gateway solutions designed to support Philippine businesses at every stage of growth — from startup to enterprise."
          showHero={true}
      ...
      {/* Solutions Section (updated to match your tab behavior; h2 kept outside <ul>) */}
      <motion.section
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Philippines, helping businesses accept payments online
                    through secure, fast, and fully compliant systems. As a payin service provider in Philippines, we
                  ...
                  <p className={styles.paragraph}>
                    ...
                    expanding into Philippines or an established brand optimizing local payments, Finsol delivers reliable,
                    scalable, and fully localized online payment solutions in Philippines.
                  </p>
                </>
              )}
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Philippines, enabling businesses to disburse payments
                    quickly, securely and in full compliance with local regulations. As a trusted payout service provider
                    in Philippines, we support a wide range of payout methods - including bank transfers, prepaid cards,
                  ...
                  <p className={styles.paragraph}>
                    ...
                    error-free transactions. Whether you are a startup scaling operations in Philippines or an enterprise
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol offers fully customizable white label payment solutions in Philippines, allowing businesses to
                  ...
                  <p className={styles.paragraph}>
                    ...
                    transaction management. Whether you are a fintech startup or an enterprise expanding into Philippines,
                    ...
                    quickly with a robust payment solution tailored for Philippines.
                  </p>
                </>
              )}
            </motion.div>
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          <motion.div className={`${styles.category} ${styles.withVideoBg}`} variants={rise} custom={1}>
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image src="/icons/countries-icon/asia/philippines/visa.png" alt="Visa" width={120} height={60} />
                <Image src="/icons/countries-icon/asia/philippines/master-card.png" alt="Mastercard" width={120} height={60} />
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image src="/icons/countries-icon/asia/philippines/gcash.png" alt="GCash" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/philippines/maya.png" alt="Maya" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image src="/icons/countries-icon/asia/philippines/pesonet.png" alt="PESONet" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/philippines/insta-pay.png" alt="InstaPay" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image src="/icons/countries-icon/asia/philippines/gcash.png" alt="GCash" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/philippines/maya.png" alt="Maya" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/philippines/coins.png" alt="Coins.ph" width={120} height={60} />
            </motion.div>
          </motion.div>
