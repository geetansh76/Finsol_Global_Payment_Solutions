...
export default function RussiaClient() {
  ...
  // Solutions tabs state (kept consistent with your preferred pattern)
    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Empowering businesses with reliable, compliant, and seamless payment solutions to grow and operate confidently in Russia’s evolving market."
          showHero={true}
      ...
      {/* Solutions Section (updated to your tabs pattern) */}
      <motion.section
      ...
      >
        <motion.div className={styles.container} variants={containerStagger}>
          {/* Left column - keep h2 inside the list, clickable lis */}
              ...
              {activeSolution === "PayIns" && (
                <>
                  ...
                  <p className={styles.paragraph}>
                    ...
                    are a startup expanding into Russia or an established brand
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/asia/russia/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/asia/russia/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                {/* If your asset is MIR, keep your current filename */}
                <Image
                  src="/icons/countries-icon/asia/russia/mnp.png"
                  alt="Mir"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/asia/russia/r-pay.png"
                alt="R-Pay"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/asia/russia/iban.png"
                alt="Bank Transfer"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              ...
              />
              <Image
                src="/icons/countries-icon/asia/russia/qiwi.png"
                alt="QIWI"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/asia/russia/webmoney.png"
                alt="WebMoney"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={9}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={10}>
              <Image
                src="/icons/countries-icon/asia/russia/sberbank.png"
                alt="Sberbank"
                width={120}
                height={60}
              />
