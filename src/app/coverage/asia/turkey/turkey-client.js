// app/coverage/asia/turkey/turkey-client.js
"use client";
...
/* =====================
   SEO constants (for JSON-LD only)
   ===================== */
...
export default function TurkeyClient() {
  ...
  // 🔹 Solutions tabs state (Japan-style tabs; keep H2 OUTSIDE the <ul>)
  ...
  return (
    <>
        ...
        <Header
          title={
            <h1 className={styles.heroTitle}>
              <span className={`${styles.line} ${styles.blueLine}`}>Reliable Payment Gateway</span>
              <span className={`${styles.line} ${styles.whiteLine}`}>Solutions for Turkey’s</span>
              <span className={`${styles.line} ${styles.blueLine}`}>Modern Business</span>
            </h1>
          }
      ...
      {/* Solutions Section (Japan-style tabs; H2 outside the <ul>) */}
      <motion.section
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Turkey, helping businesses accept payments online
                    through secure, fast, and fully compliant systems. As a payin service provider in Turkey, we
                    support a wide variety of local payment methods — including credit cards, bank transfers, UPI,
                    and mobile wallets. These localized options help businesses receive payments online from both
                    local consumers and international customers, streamlining the checkout experience and boosting
                    conversions.
                  </p>
                  <p className={styles.paragraph}>
                    Our online payment services are tailored to meet the needs of businesses operating in digital
                    economy. We offer real-time processing, multi-currency support, customizable checkout solutions,
                    and seamless integration with e-commerce platforms, SaaS applications, and mobile apps. Whether
                    you are a startup expanding into Turkey or an established brand optimizing local payments, Finsol
                    delivers reliable, scalable, and fully localized online payment solutions in Turkey.
                  </p>
                </>
              )}
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Turkey, enabling businesses to disburse payments
                    quickly, securely and in full compliance with local regulations. As a trusted payout service
                    provider in Turkey, we support a wide range of payout methods - including bank transfers, prepaid
                    cards, mobile wallets and international remittances. These flexible options help businesses
                    streamline vendor settlements, employee salaries, partner commissions and customer refunds with ease.
                  </p>
                  <p className={styles.paragraph}>
                    Our payout services are designed for the digital economy, offering real-time processing,
                    multi-currency support, bulk payouts and customizable workflows. With seamless integration into
                    e-commerce platforms, fintech applications and enterprise systems, businesses can automate
                    disbursements and ensure faster, error-free transactions. Whether you are a startup scaling
                    operations in Turkey or an enterprise managing global partners, Finsol delivers reliable, scalable
                    and fully localized payout solutions.
                  </p>
                </>
              )}
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol offers fully customizable white label payment solutions in Turkey, allowing businesses to
                    launch their own branded payment platform with complete control over the user experience, features,
                    and pricing. As a leading white label provider, we deliver the technology, infrastructure, and
                    compliance support you need to enter the payments market with speed and confidence.
                  </p>
                  <p className={styles.paragraph}>
                    Our white-label payment gateway supports local payment methods, multi-currency processing, and
                    real-time transaction management. Whether you are a fintech startup or an enterprise expanding into
                    Turkey, Finsol enables you to offer secure and scalable online payment services under your brand.
                    With full API access, localization options, and regulatory compliance built in, we make it easy to
                    go to market quickly with a robust payment solution tailored for Turkey.
                  </p>
                </>
              )}
            </motion.div>
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          <motion.div className={`${styles.category} ${styles.withVideoBg}`} variants={rise} custom={1}>
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image src="/icons/countries-icon/asia/turkey/visa.png" alt="Visa" width={120} height={60} />
                <Image src="/icons/countries-icon/asia/turkey/master-card.png" alt="Mastercard" width={120} height={60} />
                <Image src="/icons/countries-icon/asia/turkey/troy.png" alt="Troy" width={120} height={60} />
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image src="/icons/countries-icon/asia/turkey/papara.png" alt="Papara QR" width={120} height={60} />
            </motion.div>
          </motion.div>

          {/* Bank Transfers (EFT / Havale) */}
          <motion.div className={styles.category} variants={rise} custom={5}>
            <h3 className={styles.categoryTitle}>Bank Transfers (EFT / Havale)</h3>
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image src="/icons/countries-icon/asia/turkey/iban.png" alt="IBAN Transfer" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image src="/icons/countries-icon/asia/turkey/papara.png" alt="Papara" width={120} height={60} />
              <Image src="/icons/countries-icon/asia/turkey/bKm-express.png" alt="BKM Express" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={9}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={10}>
              <Image src="/icons/countries-icon/asia/turkey/iban.png" alt="Internet Banking via IBAN" width={120} height={60} />
            </motion.div>
          </motion.div>
        </motion.div>
      </motion.section>
