...
export default function JapanClient() {
  ...
  useEffect(() => {
    ...
    // Fallback: animate any single title
    const titleFallback =
    ...
    <>
      ...
      <div ref={headerScopeRef}>
        <Header
          ...
          description="Empowering businesses with reliable, compliant, and seamless transaction flows to confidently operate and expand across the Japanese market."
          showHero={true}
      ...
      >
        <motion.div className={styles.container} variants={containerStagger}>
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {/* --- PayIns content (unchanged) --- */}
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Japan, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in
                    Japan, we support a wide variety of local payment methods —
                  ...
                  <p className={styles.paragraph}>
                    ...
                    you are a startup expanding into Japan or an established
              ...
              {/* --- PayOuts content (unchanged) --- */}
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Japan, enabling
                    businesses to disburse payments quickly, securely and in
                    full compliance with local regulations. As a trusted payout
                    service provider in Japan, we support a wide range of payout
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Japan or an
              ...
              {/* --- WhiteLabeling content (unchanged) --- */}
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol offers fully customizable white label payment
                    solutions in Japan, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Japan, Finsol enables you to
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/asia/japan/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/asia/japan/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/asia/japan/jcb.png"
                  alt="JCB"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/asia/japan/american-express.png"
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/asia/japan/pay-pay.png"
                alt="PayPay"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/asia/japan/line-pay.png"
                alt="LINE Pay"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/asia/japan/japan-pay.png"
                alt="Domestic Bank Transfer"
                width={120}
                height={60}
              />
            </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image
                src="/icons/countries-icon/asia/japan/r-pay.png"
                alt="Rakuten Pay"
                width={120}
                height={60}
              />
