    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          title={
            <h1 className={styles.heroTitle}>
              <span className={`${styles.line} ${styles.blueLine}`}>
                Driving Financial Growth in
              </span>
              <span className={`${styles.line} ${styles.whiteLine}`}>
                Nigeria with Seamless
              </span>
              <span className={`${styles.line} ${styles.blueLine}`}>
                Payment Solutions
              </span>
          ...
          description="Helping Nigerian businesses simplify transactions, boost efficiency, and drive financial inclusion with reliable, scalable payment systems."
          showHero={true}
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Nigeria, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in Nigeria, we
                  ...
                  <p className={styles.paragraph}>
                    ...
                    expanding into Nigeria or an established brand optimizing local
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Nigeria, enabling
                    businesses to disburse payments quickly, securely and in
                    full compliance with local regulations. As a trusted payout
                    service provider in Nigeria, we support a wide range of payout
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Nigeria or an
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Nigeria, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Nigeria, Finsol enables you to
        ...
        <motion.div className={styles.paymentContainer} variants={containerStagger}>
          ...
          <motion.div className={`${styles.category} ${styles.withVideoBg}`} variants={rise} custom={1}>
            <div className={styles.content}>
              ...
              <motion.div className={styles.iconsRow} variants={rise} custom={2}>
                <Image src="/icons/countries-icon/africa/nigeria/visa.png" alt="Visa" width={120} height={60} />
                <Image src="/icons/countries-icon/africa/nigeria/master-card.png" alt="Mastercard" width={120} height={60} />
                <Image src="/icons/countries-icon/africa/nigeria/verve.png" alt="Verve" width={120} height={60} />
              </motion.div>
            </div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image src="/icons/countries-icon/africa/nigeria/paystack.png" alt="Paystack" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image src="/icons/countries-icon/africa/nigeria/nib.png" alt="NIBSS/NIP" width={120} height={60} />
            </motion.div>
          </motion.div>
          ...
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={8}>
              <Image src="/icons/countries-icon/africa/nigeria/flutter-wave.png" alt="Flutterwave" width={120} height={60} />
              <Image src="/icons/countries-icon/africa/nigeria/paystack.png" alt="Paystack" width={120} height={60} />
            </motion.div>
          </motion.div>
