    ...
    <>
      ...
      <div ref={headerScopeRef} >
        <Header
          ...
          description="Our secure and reliable payment systems help businesses in Kenya reduce costs, accelerate transactions, and stay focused on growth and innovation."
          showHero={true}
          ...
          <motion.div className={styles.rightColumn} variants={rightColumn}>
            ...
            >
              {activeSolution === "PayIns" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payin solutions in Kenya, helping
                    businesses accept payments online through secure, fast, and
                    fully compliant systems. As a payin service provider in Kenya, we
                  ...
                  <p className={styles.paragraph}>
                    ...
                    expanding into Kenya or an established brand optimizing
                    local payments, Finsol delivers reliable, scalable, and fully
                    localized online payment solutions in Kenya.
                  </p>
                </>
              )}
              ...
              {activeSolution === "PayOuts" && (
                <>
                  <p className={styles.paragraph}>
                    Finsol provides advanced payout solutions in Kenya, enabling
                    businesses to disburse payments quickly, securely and in
                    full compliance with local regulations. As a trusted payout
                    service provider in Kenya, we support a wide range of payout
                  ...
                  <p className={styles.paragraph}>
                    ...
                    Whether you are a startup scaling operations in Kenya or an
              ...
              {activeSolution === "WhiteLabeling" && (
                <>
                  <p className={styles.paragraph}>
                    ...
                    solutions in Kenya, allowing businesses to launch their own
                  ...
                  <p className={styles.paragraph}>
                    ...
                    an enterprise expanding into Kenya, Finsol enables you to
        ...
        >
          ...
          >
            <div className={styles.content}>
              ...
              >
                <Image
                  src="/icons/countries-icon/africa/kenya/visa.png"
                  alt="Visa"
                  width={120}
                  height={60}
                />
                <Image
                  src="/icons/countries-icon/africa/kenya/master-card.png"
                  alt="Mastercard"
                  width={120}
                  height={60}
                />
          ...
          <motion.div className={styles.category} variants={rise} custom={3}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={4}>
              <Image
                src="/icons/countries-icon/africa/kenya/m-pesa.png"
                alt="M-Pesa"
                width={120}
                height={60}
              />
              <Image
                src="/icons/countries-icon/africa/kenya/airtel-money.png"
                alt="Airtel Money"
                width={120}
                height={60}
              />
          ...
          <motion.div className={styles.category} variants={rise} custom={5}>
            ...
            <motion.div className={styles.iconsRow} variants={rise} custom={6}>
              <Image
                src="/icons/countries-icon/africa/kenya/pesa-link.png"
                alt="PesaLink"
                width={120}
                height={60}
              />
   ...
   {/* Digital Wallets */}
          <motion.div className={styles.category} variants={rise} custom={7}>
            ...
            <Image
              ...
              <Image
                src="/icons/countries-icon/africa/kenya/t-kash.png"
                alt="T cash "
                width={120}
                height={60}
              />
